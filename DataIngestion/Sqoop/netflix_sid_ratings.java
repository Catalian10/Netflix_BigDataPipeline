// ORM class for table 'netflix_sid_ratings'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Oct 17 09:16:14 UTC 2024
...
public class netflix_sid_ratings extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("userid", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        netflix_sid_ratings.this.userid = (Integer)value;
      }
    });
    setters.put("movieid", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        netflix_sid_ratings.this.movieid = (Integer)value;
      }
    });
    setters.put("rating", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        netflix_sid_ratings.this.rating = (java.math.BigDecimal)value;
      }
    });
    setters.put("timestamp", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        netflix_sid_ratings.this.timestamp = (java.sql.Timestamp)value;
      }
    });
  }
  public netflix_sid_ratings() {
    init0();
  }
  ...
  public netflix_sid_ratings with_userid(Integer userid) {
    this.userid = userid;
    return this;
  }
  ...
  public netflix_sid_ratings with_movieid(Integer movieid) {
    this.movieid = movieid;
    return this;
  }
  ...
  public netflix_sid_ratings with_rating(java.math.BigDecimal rating) {
    this.rating = rating;
    return this;
  }
  ...
  public netflix_sid_ratings with_timestamp(java.sql.Timestamp timestamp) {
    this.timestamp = timestamp;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof netflix_sid_ratings)) {
      return false;
    }
    netflix_sid_ratings that = (netflix_sid_ratings) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.rating = JdbcWritableBridge.readBigDecimal(3, __dbResults);
    this.timestamp = JdbcWritableBridge.readTimestamp(4, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeBigDecimal(rating, 3 + __off, 2, __dbStmt);
    JdbcWritableBridge.writeTimestamp(timestamp, 4 + __off, 93, __dbStmt);
    return 4;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.rating = org.apache.sqoop.lib.BigDecimalSerializer.readFields(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.timestamp = null;
    } else {
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.rating) { 
        ...
        __dataOut.writeBoolean(false);
    org.apache.sqoop.lib.BigDecimalSerializer.write(this.rating, __dataOut);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    netflix_sid_ratings o = (netflix_sid_ratings) super.clone();
    o.timestamp = (o.timestamp != null) ? (java.sql.Timestamp) o.timestamp.clone() : null;
    return o;
  }

  public void clone0(netflix_sid_ratings o) throws CloneNotSupportedException {
    o.timestamp = (o.timestamp != null) ? (java.sql.Timestamp) o.timestamp.clone() : null;
  }
